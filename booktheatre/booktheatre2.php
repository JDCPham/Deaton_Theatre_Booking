...
<div id="BookTheatreTitle">SELECT START TIME</div>
	  ...
	  $TimeErr = "Fields must not be left blank";
              ...
              if (CheckTimeValid($SelectedHour, $SelectedMinute, $SelectedDay, $SelectedMonth, $SelectedYear, $HourNow, $MinuteNow, $DayNow, $MonthNow, $YearNow) == true) {
		         $TimeErr = "Invalid Time"; 
	                     ...
	                     $StartHour = ($_POST["Hour"]);
	                     $StartMinute = ($_POST["Minute"]);
						 StoreToSession($StartHour, $StartMinute);
						 echo '<script type="text/javascript">
						 window.location = "booktheatre3.php"
						 </script>';	
				 }	
	  }
  }
...
function StoreToSession($StartHour, $StartMinute) {
